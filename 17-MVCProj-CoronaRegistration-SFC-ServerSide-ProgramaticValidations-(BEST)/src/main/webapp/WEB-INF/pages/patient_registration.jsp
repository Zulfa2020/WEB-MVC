  ...
  <form:form  modelAttribute="patCmd"  onsubmit="return validate(this)">
     <%--   <p style="color:red">
         ...
         <table bgcolor="cyan" align="center">
             <tr>
                <td>Patient Name:: </td>
                <td><form:input path="patName"/> <form:errors path="patName"/>
                <span id="patNameErr"></span> </td>
             </tr>
             <tr>
                <td>Patient Location:: </td>
                <td><form:input path="location"/><form:errors path="location"/>
                <span id="locationErr"></span>  </td>
             </tr>
             <tr>
                <td>Patient age:: </td>
                <td><form:input path="age"/> <form:errors path="age"/>
                <span id="ageErr"></span> </td>
             </tr>
             <tr>
                <td>Hospital:: </td>
                <td><form:input path="hospital"/> <form:errors path="hospital"/>
                <span id="hospitalErr"></span> </td>
             </tr>
